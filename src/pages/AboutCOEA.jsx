...
const AboutCOEA = () => {
  ...
  const slides = [
    {
      image: '../assets/aSTRONOMY_3.jpg',
      alt: 'Astronomy Observatory 3',
    },
    {
      image: '../assets/ASTRONOMY_6.JPG',
      alt: 'Astronomy Observatory 6',
    },
    {
      image: '../assets/ASTRONOMY_5.jpg',
      alt: 'Astronomy Observatory 5',
    },
    {
      image: '../assets/ASTRONOMY_COE_2.jpeg',
      alt: 'Astronomy COE Facility 2',
    },
    {
      image: '../assets/Astronomy_COE_1.jpeg',
      alt: 'Astronomy COE Facility 1',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-cover bg-center bg-fixed mt-8 lg:mt-20" style={{ backgroundImage: "url('../assets/AboutBg.png')" }}>
      ...
      <header className="text-center py-8 animate-fadeInUp">
        <img src="../assets/Space_Observatory_Logo.png" alt="COEA Logo" className="w-36 mx-auto mb-4" />
        <h1 className="text-3xl lg:text-5xl font-extrabold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">
          Centre of Excellence in Astronomical Studies
        </h1>
      </header>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 px-4 lg:px-12 py-8 max-w-7xl mx-auto">
        ...
        <div className="bg-white p-8 shadow-lg rounded-lg hover:shadow-2xl transition-shadow duration-300 animate-fadeInUp">
          ...
          <p className="text-base text-gray-700 leading-relaxed mb-4 text-justify">
            The Centre of Excellence in Astronomical Studies (CoE AS) at University of Engineering and Management, Kolkata is dedicated to fostering education and public outreach in the field of astronomy and astrophysics. This centre has an observatory named Prof. Amal Kumar Raychaudhuri Observatory. As a premier academic and research hub, the Centre serves as a bridge between theoretical knowledge and practical application, addressing fundamental questions about the universe, celestial phenomena, and space exploration. This Centre features both optical and radio telescopes.
          </p>
          <p className="text-base text-gray-700 leading-relaxed text-justify">
            Students, faculty members, and visitors can explore the night sky at our observatory. We organize special lecture series on astronomy, providing students with comprehensive knowledge. Over 300 school students from various institutions have visited us. Additionally, we offer hands-on workshops on telescope making using everyday materials, enabling students to build their own telescopes. Our radio telescope facilitates satellite tracking and signal processing from various celestial radio sources.
          </p>
        </div>
